...
//            InitializeComponent(int numCamaras)
//
//            this.camaras = new List<ThermoVision.CamConfigControl>();
//            this.SuspendLayout();
...
//            for (int i = 0; i < numCamaras; i++)
//            {
//                ThermoVision.CamConfigControl c = new ThermoVision.CamConfigControl();
...
//private List<ThermoVision.CamConfigControl> camaras;