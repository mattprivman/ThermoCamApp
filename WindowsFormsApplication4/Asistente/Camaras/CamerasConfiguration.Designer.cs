...
namespace WindowsFormsApplication4.Asistente.Camaras
{
    partial class CamerasConfiguration
    {
        ...
        private void InitializeComponentWithSistema(int numCamaras)
        {
            this.camaras = new List<ThermoVision.CustomControls.CamConfigControl>();
            this.buttonAtras = new System.Windows.Forms.Button();
            this.buttonNext = new System.Windows.Forms.Button();
            ...
            //Comprobar que el numero de camaras seleccionado sea igual al numero de las que hay en sistema
            if (numCamaras == this._system.ThermoCams.Count)
            {
                //TODO BIEN
            }
            ...
            {
                //HAY DE MENOS
                this._system = new ThermoVision.Models.Sistema();
                InitializeComponent(numCamaras);
                return;
            }
            ...
            for (int i = 0; i < numCamaras; i++)
            {
                ...
                c.Initialize(this, this._system, this._system.ThermoCams[i]);
