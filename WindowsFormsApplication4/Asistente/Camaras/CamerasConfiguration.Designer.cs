...
namespace WindowsFormsApplication4.Asistente.Camaras
{
    partial class CamerasConfiguration
    {
        ...
        /// </summary>
        private void InitializeComponent(int numCamaras, List<ThermoVision.Models.ThermoCam> _thermoCams = null)
        {
            ...
            // buttonAtras
            // 
            this.buttonAtras.Location = new System.Drawing.Point(
                numCamaras * this.camaras[0].Width - 2 * (10 + 75),     //COORDENADAS DE DIBUJO
                757);
